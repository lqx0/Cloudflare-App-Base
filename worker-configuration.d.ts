/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e2baddbce28943b4ec48f06cecc4fe4)
// Runtime types generated with workerd@1.20260611.1 2025-04-01 nodejs_compat
interface __BaseEnv_Env {
	...
	APP_BASE_URL: string;
	CLI_ADMIN_EMAIL: string;
	CLI_ADMIN_PASSWORD: string;
	CLI_API_URL: string;
	CLI_API_URL_PREVIEW: string;
	CLI_API_URL_PRODUCTION: string;
	CLI_MOCK: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_PROVIDER" | "AUTH_EMAILS_LOCAL_ENABLED" | "EMAIL_API_KEY" | "APP_BASE_URL" | "CLI_ADMIN_EMAIL" | "CLI_ADMIN_PASSWORD" | "CLI_API_URL" | "CLI_API_URL_PREVIEW" | "CLI_API_URL_PRODUCTION" | "CLI_MOCK">> {}
}
